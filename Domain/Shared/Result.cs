...
/// <summary>
/// Represent a result of some operation, with status information and possibly an error.
/// </summary>
public class Result
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="isSuccess">The flag indicating if the result is sucessful.</param>
    ...
    /// <summary>
    /// Returns a failture <see cref="Result"/> with the specified error.
    /// </summary>
    ...
    /// <summary>
    /// Returns a sucess <see cref="Result"/>
    /// </summary>
    ...
    /// <summary>
    /// Creates a new <see cref="Result{TValue}"/> with the specified nullable value and specified error.
    /// </summary>
    /// <typeparam name="TValue">The result type.</typeparam>
    /// <param name="value">The result value.</param>
    ...
    /// <returns>
    /// The first failure from the specified <paramref name="results"/> array, or a success if does not exist.
    /// </returns>
